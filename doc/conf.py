# -*- coding: utf-8 -*-
#
# PyCogent documentation build configuration file, created by
# sphinx-quickstart on Wed May 13 12:28:51 2009.
#
...
project = u'EnsemblDb'
copyright = u'2016, EnsemblDb Team'
...
# The name of an image file (within the carry path) to use as favicon of the
