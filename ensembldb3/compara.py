    ...
    def get_related_genes(self, gene_region=None, stableid=None,
        ...
        for r in homology_records.execute():
            homology_ids.append((r["homology_id"],
                                 (r["description"], r["method_link_species_set_id"], r['goc_score'])))
